...
if __name__ == '__main__':
    try:
        ...
        # The order of side_inputs must match the order expected by the model
        # based on trainer.py: class_a, class_f, class_g, class_d, class_e, class_b, class_c
        
        # Reshape main_input for the model (add batch dimension)
        main_input_reshaped = np.expand_dims(main_input.to_numpy(), axis=0)

        # Reshape side_inputs for the model (add batch dimension)
        # Ensure the order matches trainer.py's prepare_model_inputs
        # side_input_1: class_a
        # side_input_2: class_f
        # side_input_3: class_g
        # side_input_4: class_d
        # side_input_5: class_e
        # side_input_6: class_b
        # side_input_7: class_c
